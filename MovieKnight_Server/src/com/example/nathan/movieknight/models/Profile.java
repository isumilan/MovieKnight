...
public class Profile implements Serializable {
	...
	public Vector<String> getToWatchName() { 
		return toWatchName; 
	}
	public Vector<String> getWatchedName() { 
		return watchedName; 
	}
	...
	public void setToWatchName(Vector<String> toWatchName) { 
		this.toWatchName = toWatchName; 
	}
	public void setWatchedName(Vector<String> watchedName) { 
